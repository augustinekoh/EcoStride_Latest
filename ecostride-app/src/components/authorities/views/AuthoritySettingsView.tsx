...
import { Send, Loader2, User as UserIcon, MessageSquare, Inbox, Search, MapPin, Trash2, Send as SendIcon, LogOut } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="md:hidden bg-red-50 hover:bg-red-100 text-red-600 rounded-3xl p-5 font-bold flex items-center justify-center gap-3 transition-colors shadow-sm"
            >
              <LogOut size={22} />
              Sign Out
            </button>
