...
export const CarbonStatsModal: React.FC<CarbonStatsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-[var(--color-teal-dark)]/20 backdrop-blur-xl flex flex-col items-center justify-end md:justify-center animate-in fade-in duration-300 p-4 md:p-0">
      <div className="w-full max-w-md glass-card rounded-[24px] flex flex-col animate-in slide-in-from-bottom-10">
        <div className="flex justify-between items-center p-6 border-b border-white/40">
          ...
          <button 
            onClick={onClose}
            className="w-10 h-10 glass-active rounded-full flex items-center justify-center hover:scale-105 transition-transform"
          >
        ...
        <div className="p-6 overflow-y-auto">
          <div className="glass-active rounded-2xl p-5 mb-6 text-center border border-white/50 shadow-sm">
            ...
            <div className="mt-4 bg-[var(--color-pastel-yellow)] text-[var(--color-text-main)] px-4 py-2 rounded-xl text-xs font-bold border border-white/50 inline-block shadow-sm">
          ...
          <div className="glass-active rounded-2xl p-5 h-48 flex items-end justify-between gap-2 relative pt-6 border border-white/50 shadow-sm">
